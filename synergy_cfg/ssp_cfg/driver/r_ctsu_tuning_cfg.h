...
#ifndef R_CTSU_TUNING_CFG_H_
#define R_CTSU_TUNING_CFG_H_
...
#define CTSU_TUNING_BUTTONS         (1)
#define CTSU_TUNING_SLIDERS_WHEELS  (0)
#define CTSU_TUNING_MODE            (1)
/* Define the options for CTSU_TUNING_MODE above */
#define CTSU_MODE_SELF              (0)
#define CTSU_MODE_MUTUAL            (1)
#endif /* R_CTSU_TUNING_CFG_H_ */
