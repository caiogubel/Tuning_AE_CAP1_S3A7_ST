 ...
 * @defgroup BSP_S3A7_AE-CAP1 Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the DK7M board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
***********************************************************************************************************************/
