...
* Description  : BSP reference configuration file for S3A7 device.
***********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup BSP_CONFIG_S3A7
 * @defgroup BSP_CONFIG_S3A7_GENERAL Build Time Configurations - General
 *
 ...
 * |    |____________________BSP_CFG_MCU_PART_SERIES       = Performance category (High-efficiency -
 *                                                           Low power)
 ...
 * </PRE>
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE                (0x0C)
 ...
 * </PRE>
*/
#define BSP_CFG_MCU_PART_CORE                       (0x0A)
 ...
 * </PRE>
*/
#define BSP_CFG_MCU_PART_SERIES                     (0x3)
...
#endif /* BSP_BOARD_S3A7_AE_CAP1 */

/** @} (end of defgroup BSP_CONFIG_S3A7_GENERAL) */
