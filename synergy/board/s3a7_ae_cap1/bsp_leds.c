...
#if defined(BSP_BOARD_S3A7_AE_CAP1)
...
{
    IOPORT_PORT_09_PIN_00,  ///< LED1 Red
    IOPORT_PORT_09_PIN_01,  ///< LED2 Yellow
    IOPORT_PORT_09_PIN_02,  ///< LED3 Green
};
...
/** @} (end addtogroup BSP_S3A7_AE_CAP1) */
