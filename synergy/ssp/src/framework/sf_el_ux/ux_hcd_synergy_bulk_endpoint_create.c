 ...
 * @retval UX_NO_TD_AVAILABLE   Dummy TD for for terminating the ED transfer chain is not available.
 **********************************************************************************************************************/
...
TX_INTERRUPT_SAVE_AREA
    ...
    ed -> ux_synergy_buffer_number = (ULONG)UX_SYNERGY_HC_PIPE1_BUF_START_NUM +
            ((pipe_index - 1UL) * (ed -> ux_synergy_buffer_size));
