...
TX_INTERRUPT_SAVE_AREA
    ...
    if ((ed -> ux_dcd_synergy_ed_status & UX_DCD_SYNERGY_ED_STATUS_USED) == 0)
    {
        ...
        ed->ux_dcd_synergy_ed_fifo_index =  UX_SYNERGY_DCD_FIFO_C;
#else
        ...
        else
        {
            ...
            ux_dcd_synergy_register_set(dcd_synergy,
                    (ULONG)(UX_SYNERGY_DCD_PIPE1CTR + ((ed -> ux_dcd_synergy_ed_index - 1UL) * 2U)),
                                                        (USHORT)UX_SYNERGY_DCD_DCPCTR_PIDNAK);
