...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    ux_dcd_synergy_buffer_empty_interrupt               PORTABLE C      */
/*                                                           5.6          */ 
/*  AUTHOR                                                                */ 
/*                                                                        */ 
...
/*******************************************************************************************************************//**
 * @brief  This function processes the BEMP interrupt for the specific endpoint.
 *
 * @param[in]  dcd_synergy  Pointer to a DCD control block
 * @param[in]  ed           Pointer to physical Endpoint(ED) control block
 * @param[in]  flag         Flag to enable or disable the buffer empty interrupt.
 **********************************************************************************************************************/
VOID  ux_dcd_synergy_buffer_empty_interrupt(UX_DCD_SYNERGY *dcd_synergy, UX_DCD_SYNERGY_ED *ed, ULONG flag)
{
    ...
    ux_dcd_synergy_register_clear(dcd_synergy, UX_SYNERGY_DCD_INTENB0,
            UX_SYNERGY_DCD_INTENB0_BEMPE | UX_SYNERGY_DCD_INTENB0_NRDYE | UX_SYNERGY_DCD_INTENB0_BEMPE);

    /* Read the BEMP register.  */
    synergy_bemp_register = ux_dcd_synergy_register_read(dcd_synergy, UX_SYNERGY_DCD_BEMPENB);

    /* Enable or Disable ?  */
    if (flag == (ULONG) UX_DCD_SYNERGY_ENABLE)
    {
        /* Set the appropriate endpoint number.  */
        synergy_bemp_register |= (ULONG) (1UL << ed -> ux_dcd_synergy_ed_index);
    }
    else
    {
    ...
    ux_dcd_synergy_register_write(dcd_synergy, UX_SYNERGY_DCD_BEMPENB, (USHORT)synergy_bemp_register);
