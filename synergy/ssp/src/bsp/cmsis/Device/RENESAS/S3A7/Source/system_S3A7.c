...
static void bsp_reset_trng_circuit (void)
{
    ...
    /* Enable SCE5 function (disable stop function) */
    R_MSTP->MSTPCRC_b.MSTPC31 = 0U;      ///< SCE5 Module Stop needs to be started/stopped for S3 series.
    ...
    /* Disable SCE5 function (enable stop function) */
