 ...
 * @defgroup BSP_MCU_MODULE_STOP Module Start and Stop
 *
...
#define HW_GPT_MSTPD5_MAX_CH (3U)
...
static const uint8_t g_bsp_module_stop[] =
{
    ...
    BSP_MSTP_REG(BSP_MSTPCRA) | BSP_MSTP_BIT(22U) | BSP_MSTP_EXCEPTION, // SSP_IP_DMAC=7,
    BSP_MSTP_REG(BSP_MSTPCRA) | BSP_MSTP_BIT(22U) | BSP_MSTP_EXCEPTION, // SSP_IP_DTC=8,
    ...
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(31U),                      // SSP_IP_SCE=24,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(4U),                       // SSP_IP_SLCDC=25,
    BSP_MSTP_DATA_INVALID,                                             // SSP_IP_AES=26,
    BSP_MSTP_DATA_INVALID,                                             // SSP_IP_TRNG=27,
    ...
    BSP_MSTP_REG(BSP_MSTPCRD) | BSP_MSTP_BIT(28U) | BSP_MSTP_EXCEPTION, // SSP_IP_COMP_HS=36,
    BSP_MSTP_REG(BSP_MSTPCRD) | BSP_MSTP_BIT(29U),                      // SSP_IP_COMP_LP=37,
    ...
    BSP_MSTP_REG(BSP_MSTPCRB) | BSP_MSTP_BIT(5U),                       // SSP_IP_IRDA=49,
    BSP_MSTP_DATA_INVALID,                                             // SSP_IP_QSPI=50,
    BSP_MSTP_REG(BSP_MSTPCRB) | BSP_MSTP_BIT(11U) | BSP_MSTP_EXCEPTION, // SSP_IP_USB=51,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(12U),                      // SSP_IP_SDHIMMC=52,
    BSP_MSTP_DATA_INVALID,                                             // SSP_IP_SRC=53,
    BSP_MSTP_REG(BSP_MSTPCRC) | BSP_MSTP_BIT(8U),                       // SSP_IP_SSI=54,
...
static ssp_err_t r_bsp_module_start_stop (ssp_feature_t const * const p_feature, bool stop)
{
    ...
    if (stop)
    {
        if ((!data.bit.exception) || (SSP_IP_COMP_HS == p_feature->id))
        {
...
/** @} (end defgroup BSP_MCU_MODULE_STOP) */
