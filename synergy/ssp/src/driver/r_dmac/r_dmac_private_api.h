...
#ifndef R_DMAC_PRIVATE_API_H
#define R_DMAC_PRIVATE_API_H
 ...
 **********************************************************************************************************************/
ssp_err_t R_DMAC_Open      (transfer_ctrl_t        * const p_ctrl,
                            transfer_cfg_t const * const   p_cfg);
ssp_err_t R_DMAC_Reset     (transfer_ctrl_t        * const    p_ctrl,
                            void const * volatile             p_src,
                            void                   * volatile p_dest,
                            uint16_t const                    num_transfers);
ssp_err_t R_DMAC_Start     (transfer_ctrl_t        * const p_ctrl,
...
ssp_err_t R_DMAC_InfoGet   (transfer_ctrl_t        * const p_ctrl,
                            transfer_properties_t  * const p_info);
ssp_err_t R_DMAC_Close     (transfer_ctrl_t        * const p_ctrl);
ssp_err_t R_DMAC_VersionGet (ssp_version_t          * const p_version);
ssp_err_t R_DMAC_BlockReset (transfer_ctrl_t        * const p_ctrl,
                            void           const * volatile p_src,
                            void                 * volatile p_dest,
