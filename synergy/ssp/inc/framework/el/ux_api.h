...
/*******************************************************************************************************************//**
 * @ingroup SF_Library
 * @defgroup sf_el_ux SF_EL_UX Framework
 * @brief RTOS-integrated SF_EL_UX Framework.
 *
 * @{
 **********************************************************************************************************************/
...
#define UX_TRACE_DEVICE_CLASS_STORAGE_OTHER                             (UX_TRACE_DEVICE_CLASS_EVENTS_BASE + 87)            /* I1 = class instance  , I2 = lun                                                                  */       
...
#endif 
#define UX_CONTROL_TRANSFER_TIMEOUT                                     ((UX_CONTROL_TRANSFER_TIMEOUT_IN_MS) * (UX_PERIODIC_RATE) / 1000)

#ifndef UX_NON_CONTROL_TRANSFER_TIMEOUT_IN_MS
#define UX_NON_CONTROL_TRANSFER_TIMEOUT_IN_MS                           50000
#endif 
#define UX_NON_CONTROL_TRANSFER_TIMEOUT                                 ((UX_NON_CONTROL_TRANSFER_TIMEOUT_IN_MS) * (UX_PERIODIC_RATE) / 1000)

#ifndef UX_PORT_ENABLE_WAIT_IN_MS          
#define UX_PORT_ENABLE_WAIT_IN_MS                                       500
#endif
#define UX_PORT_ENABLE_WAIT                                             ((UX_PORT_ENABLE_WAIT_IN_MS) * (UX_PERIODIC_RATE) / 1000)

#ifndef UX_DEVICE_ADDRESS_SET_WAIT_IN_MS                         
#define UX_DEVCIE_ADDRESS_SET_WAIT_IN_MS                                500
#endif
#define UX_DEVICE_ADDRESS_SET_WAIT                                      ((UX_DEVCIE_ADDRESS_SET_WAIT_IN_MS) * (UX_PERIODIC_RATE) / 1000)
...
#endif
#define UX_HIGH_SPEED_DETECTION_HANDSHAKE_SUSPEND_WAIT                  ((UX_HIGH_SPEED_DETECTION_HANDSHAKE_SUSPEND_WAIT_IN_MS) * (UX_PERIODIC_RATE) / 1000)


#ifndef UX_ENUMERATION_THREAD_WAIT_IN_MS                             
#define UX_ENUMERATION_THREAD_WAIT_IN_MS                                2000
#endif
#define UX_ENUMERATION_THREAD_WAIT                                      ((UX_ENUMERATION_THREAD_WAIT_IN_MS) * (UX_PERIODIC_RATE) / 1000)
...
#define ux_device_stack_transfer_request_abort                  _ux_device_stack_transfer_request_abort
...
/*******************************************************************************************************************//**
 * @ingroup SF_Library
 * @defgroup SF_EL_UX_API SF_EL_UX Framework
 * @brief RTOS-integrated SF_EL_UX Framework.
 *
 * @section SF_EL_UX_API_SUMMARY Summary
