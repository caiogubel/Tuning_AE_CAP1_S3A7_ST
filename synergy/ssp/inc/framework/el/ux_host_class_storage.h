...
//#define UX_HOST_CLASS_STORAGE_MAX_MEDIA                     8
...
#define UX_HOST_CLASS_STORAGE_DEVICE_INIT_DELAY             (2 * UX_PERIODIC_RATE)
#define UX_HOST_CLASS_STORAGE_THREAD_SLEEP_TIME             (2 * UX_PERIODIC_RATE)
