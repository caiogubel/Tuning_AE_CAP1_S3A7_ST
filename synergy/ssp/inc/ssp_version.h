...
#define SSP_VERSION_PATCH                   (2U)

/** SSP pack version build number (currently unused). */
#define SSP_VERSION_BUILD                   (0U)

/** Public SSP version name. */
#define SSP_VERSION_STRING                  ("1.3.2")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 1.3.2+build.dd1f2d3bc287")
